...
test('mobile exposes a native model dropdown, binds settings after its function, and preserves zoom controls', () => {
  ...
  assert.match(html, /--mobile-top-clearance: calc\(env\(safe-area-inset-top, 0px\) \+ 54px\)/);
