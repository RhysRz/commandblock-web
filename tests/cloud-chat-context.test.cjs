...
test('Cloud chat keeps bounded context and saves each agent phase with an interrupted checkpoint', () => {
  ...
  assert.doesNotMatch(adapter, /saveMessage\(session, 'assistant', lastContent\)/);
